...
clusterExport(cl, c("DAT", "YY", "OFF", "BB", "SSH", "OFFmean", ".run_path2"))

cat("OK\n* Establishing checkpoint ... ")
#SPP <- colnames(YY)
SPP <- c("MODO", "YBSA", "ATTW", "BBWO", "DOWO", "HAWO", "NOFL", "PIWO",
    "EAKI", "OSFL", "WEWP", "YBFL", "ALFL", "LEFL", "BHVI", "PHVI",
    "WAVI", "REVI", "GRAJ", "BLJA", "BBMA", "AMCR", "CORA", "HOLA",
    "TRES", "BARS", "BCCH", "BOCH", "RBNU", "WBNU", "BRCR", "HOWR",
    "WIWR", "GCKI", "RCKI", "VEER", "SWTH", "HETH", "AMRO", "VATH",
    "GRCA", "CEDW", "EVGR", "PUFI", "WWCR", "PISI", "AMGO", "CHSP",
    "CCSP", "VESP", "SAVS", "LCSP", "FOSP", "SOSP", "LISP", "SWSP",
    "WTSP", "WCSP", "DEJU", "BAOR", "RWBL", "BHCO", "RUBL", "BRBL",
    "OVEN", "NOWA", "BAWW", "TEWA", "OCWA", "CONW", "MOWA", "COYE",
    "AMRE", "CMWA", "MAWA", "BBWA", "YEWA", "BLPW", "PAWA", "YRWA",
    "BTNW", "CAWA", "WIWA", "WETA", "RBGR")
DONE <- character(0)
if (interactive() | TEST)
    SPP <- SPP[1:2]
