...
modsShf <- list(
        ...
        .~. + Remn_KM + THF_KM,
        .~. + Remn_KM + Lin_KM + Nonlin_KM,
        .~. + Remn_KM + Succ_KM + Alien_KM,
        .~. + Remn_KM + Succ_KM + Noncult_KM + Cult_KM,
        .~. + Remn_KM + THF_KM + THF2_KM,
        .~. + Remn_KM + Lin_KM + Nonlin_KM + Nonlin2_KM,
        .~. + Remn_KM + Succ_KM + Alien_KM + Succ2_KM,
        .~. + Remn_KM + Succ_KM + Noncult_KM + Cult_KM + Succ2_KM,
        .~. + Remn_KM + Succ_KM + Alien_KM + Alien2_KM,
        .~. + Remn_KM + Succ_KM + Noncult_KM + Cult_KM + Noncult2_KM,
        .~. + Remn_KM + Succ_KM + Alien_KM + Succ2_KM + Alien2_KM,
        .~. + Remn_KM + Succ_KM + Noncult_KM + Cult_KM + Succ2_KM + Noncult2_KM,

        .~. + Remn_KM + Remn2_KM + THF_KM,
        .~. + Remn_KM + Remn2_KM + Lin_KM + Nonlin_KM,
        .~. + Remn_KM + Remn2_KM + Succ_KM + Alien_KM,
        .~. + Remn_KM + Remn2_KM + Succ_KM + Noncult_KM + Cult_KM,
        .~. + Remn_KM + Remn2_KM + THF_KM + THF2_KM,
        .~. + Remn_KM + Remn2_KM + Lin_KM + Nonlin_KM + Nonlin2_KM,
        .~. + Remn_KM + Remn2_KM + Succ_KM + Alien_KM + Succ2_KM,
        .~. + Remn_KM + Remn2_KM + Succ_KM + Noncult_KM + Cult_KM + Succ2_KM,
        .~. + Remn_KM + Remn2_KM + Succ_KM + Alien_KM + Alien2_KM,
